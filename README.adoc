...
The wrapper class has the `type` attribute along with a `Quote`. This makes it easy later to use Spring's `RestTemplate` and convert JSON to a link:/understanding/POJO[POJO] with the Jackson binding library.
